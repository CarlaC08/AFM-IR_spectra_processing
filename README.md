...
In this app, you'll find 2 pages: "Laser breaks correction" and "Visualisation of IconIR spectra on map".
...
For this page, the IconIR and GloveBox systems are grouped under the IconIR name because they use the same data format.
 - OPTIR Mirage : from Photothermal
 - Nano IR2 : from Anasys Instrument

#### Visualisation of IconIR spectra on map
This 2nd page **ONLY** works for the IconIR system from Bruker. It allows to plot the position of the spectra on the corresponding map, and to visualise and apply basic operation to the spectra.  
